...
def attack(char_name: str, char_class: str) -> str:
    """Return random damage number based on character atributes."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return random block number based on character atributes."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return class-special ability description and buff/damage/def number."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Return training introduction based on character class."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Return character class and description based on gamer choice."""
    approve_choice: str = ''
    char_class: str = ''
